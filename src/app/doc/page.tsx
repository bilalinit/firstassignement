export default function Doc() {
    return (
      <div className="grid grid-cols-12 grid-rows-12 gap-5">
        <div className="bg-ryzen-850 rounded-full inline-flex items-center p-5 col-span-2 row-span-1 text-white font-bold">Documentation
        ...
        <div className="bg-ryzen-950 rounded-2xl inline-flex items-center p-5 col-span-2 row-span-3">
          4
        </div>
